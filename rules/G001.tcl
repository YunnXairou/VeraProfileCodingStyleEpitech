...
foreach f [getSourceFileNames] {
    ...
    foreach line [getAllLines $f] {
        ...
        if {[regexp {^Makefile$} $f] && [regexp {^##} $line] 
        ||  $lineNumber == 1 && [regexp {^\/\*} $line]
    ...
    if {$count == 6} {
        ...
        report $rule 1 "you must start your source code with a correctly formatted Epitech standard header"
    }
}
